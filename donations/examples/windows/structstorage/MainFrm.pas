{
  Fairly complete demo program for the JclStructStore unit.
...
uses
  ...
  ActnList, ImgList, Controls, Dialogs, ExtCtrls, Graphics, HexDump, JclStructStore;
...
begin
  ...
  begin
    ...
    JclStructStore.CoMallocFree(Stat.pwcsName);
  end;
end;

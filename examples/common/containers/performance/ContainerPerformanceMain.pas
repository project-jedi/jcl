...
procedure TMainForm.btnTArrayListClick(Sender: TObject);
var
  List: IList;
  It: IIterator;
  I, Res: Integer;
...
procedure TMainForm.btnTListClick(Sender: TObject);
var
  List: TList;
  I, res: Integer;
  Start: TDateTime;
...
procedure TMainForm.btnTLinkedListClick(Sender: TObject);
var
  List: IList;
  I, Res: Integer;
  It: IIterator;
...
procedure TMainForm.btnTSpeedListClick(Sender: TObject);
var
  List: TJclVector;
  I, res: Integer;
  Start: TDateTime;
...
procedure TMainForm.btnTHashMapClick(Sender: TObject);
var
  Map: IMap;
  I, Res: Integer;
  Start: TDateTime;
...
procedure TMainForm.btnBucketListClick(Sender: TObject);
{$IFDEF DELPHI6_UP}
var
  I, Res: Integer;
  Start: TDateTime;
...
procedure TMainForm.btnHashedStringClick(Sender: TObject);
{$IFDEF DELPHI6_UP}
var
  I: Integer;
  Index: Integer;

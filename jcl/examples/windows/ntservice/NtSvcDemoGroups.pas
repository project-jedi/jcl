...
class function TfrmServiceGroups.Execute(
  const NtSvc: TJclNtService): TJclNtService;
begin
  ...
  with NtSvc.SCManager do
    ...
    begin
      ...
      begin
        ...
        SvcNode := treeServices.Items.AddChildObject(GrpNode,
          CurNtSvc.ServiceName, CurNtSvc);

...
|==============================================================================|
| History:                                                                     |
| 02.07.2000 000.005.000 First version                                         |
| 19.10.2000 000.005.001 Version info displaying added                         |
| 12.12.2000 000.005.002 Pascal interface unit generator added                 |
|                        Export section name added                             |
|                        Drag&Drop files and command line parameter added      |
|                        Partial name unmangling, Find text dialog             |
| 01.02.2001 000.005.003 JCL 1.0 compatible                                    |
|==============================================================================}
...
uses ActiveX, ClipBrd, ToolsUtils, JclFileUtils,

{==============================================================================|
| Project : Delphi Tools                                         | 000.005.000 |
|==============================================================================|
...
resourcestring
  RsToolsLink = 'Delphi Tools;http://www.volweb.cz/pvones/delphi';
  RsDelphreeLink = 'Delphree Open Source Initiative;http://delphree.clexpert.com';
...
procedure SendEmail;
begin
  ShellExec(RsEmailAddress);
end;

procedure ShowToolsAboutBox;
begin
  ShowAbout([RsToolsLink, RsDelphreeLink, RsJCLLink], 18);
end;

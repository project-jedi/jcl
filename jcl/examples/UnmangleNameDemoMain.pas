...
begin
  ...
  LabelCaptionParam(Label1, YesNoText[BorImage.IsBorlandImage]);
  LabelCaptionParam(Label2, YesNoText[BorImage.IsPackage]);
  LabelCaptionParam(Label3, BorImage.FileName);
  if BorImage.IsPackage then
    LabelCaptionParam(Label4, BorImage.PackageInfo.Description)
  else
    LabelCaptionParam(Label4, '');
end;

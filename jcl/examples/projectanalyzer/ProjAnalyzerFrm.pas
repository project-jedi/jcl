...
resourcestring
  ...
  RsStatusText = 'Units: %d, Forms: %d, Code: %d, Data: %d, Resources: %d';
...
begin
  ...
  StatusBar1.Panels[0].Text := Format(RsStatusText,
    [FUnitsSum.Count, Length(FDfms), FCodeSize, FDataSize, ResourcesSize]);
  with ActionList1 do

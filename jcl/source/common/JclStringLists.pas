...
type
  ...
  public
    { IInterface }
     function _AddRef: Integer; {$IFDEF FPCNONWINDOWS}cdecl{$ELSE}stdcall{$ENDIF};
     function _Release: Integer; {$IFDEF FPCNONWINDOWS}cdecl{$ELSE}stdcall{$ENDIF};
     function QueryInterface({$IFDEF FPC_HAS_CONSTREF}constref{$ELSE}const{$ENDIF} IID: TGUID; out Obj): HResult; {$IFDEF FPCNONWINDOWS}cdecl{$ELSE}stdcall{$ENDIF};
...
function TJclInterfacedStringList._AddRef: Integer;{$IFDEF FPCNONWINDOWS}cdecl{$ELSE}stdcall{$ENDIF};
begin
...
function TJclInterfacedStringList._Release: Integer;{$IFDEF FPCNONWINDOWS}cdecl{$ELSE}stdcall{$ENDIF};
begin
  if assigned(FOwnerInterface) then
...
function TJclInterfacedStringList.QueryInterface({$IFDEF FPC_HAS_CONSTREF}constref{$ELSE}const{$ENDIF} IID: TGUID; out Obj): HResult;{$IFDEF FPCNONWINDOWS}cdecl{$ELSE}stdcall{$ENDIF};
begin

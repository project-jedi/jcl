...
resourcestring
  ...
  RsIdePackageUninstallationFinished =
    'Uninstallation of ide package finished';
  ...
  RsECmdLineToolOutputInvalid =
    '%s: Output invalid, when OutputCallback assigned.';
  ...
  RsEDualPackageNotSupported =
    'This installation of %s doesn''t support dual packages';
  RsEx64PlatformNotValid =
    'This installation cannot generate x64 binaries';
  {$IFDEF MSWINDOWS}
  RsENoOpenHelp =
    'open help not present in Borland Developer Studio';
  {$ENDIF MSWINDOWS}
...
resourcestring
  ...
  RsCILDescrisinst =
    'test if object is an instance of class, returning NULL or an instance of that class or interface';
  RsCILDescrconvrun =
  ...
  RsCILDescrstfld =
    'Replace the value of field of the object obj with val';
  ...
  RsCILDescrstobj =
    'Store a value of type classTok from the stack into memory';
  ...
  RsCILDescrldelemu4 =
    'Load the element with type unsigned int32 at index onto the top of the stack as an int32 (alias for ldelem.i4)';
  RsCILDescrldelemi8 =
    'Load the element with type int64 at index onto the top of the stack as an int64';
  RsCILDescrldelemi =
    'Load the element with type native int at index onto the top of the stack as an native int';
  RsCILDescrldelemr4 =
  ...
  RsCILDescrldelemref =
    'Load the element of type object, at index onto the top of the stack as an O';
  RsCILDescrstelemi =
  ...
  RsCILDescrsubovf =
    'Subtract native int from an native int. Signed result must fit in same size';
  RsCILDescrsubovfun =
  ...
  RsCILDescrunused65 = '';
  RsCILDescrsizeof =
    'Push the size, in bytes, of a value type as a unsigned int32';
...
resourcestring
  RsClrCopyright =
    '// Delphi-JEDI .NET Framework IL Disassembler.  Version 0.1' + sLineBreak +
    '// Project JEDI Code Library (JCL) Team. All rights reserved.' +
    sLineBreak;
...
resourcestring
  RsComInvalidParam =
    'An invalid parameter was passed to the routine. If a parameter was ' +
    'expected, it might be an unassigned item or nil pointer';
  RsComFailedStreamRead =
    'Failed to read all of the data from the specified stream';
  RsComFailedStreamWrite =
    'Failed to write all of the data into the specified stream';

//=== JclComplex =============================================================
resourcestring
  RsComplexInvalidString =
    'Failed to create a complex number from the string provided';
...
resourcestring
  ...
  RsCompressionGZIPUnsupportedCM =
    'gzip: unsupported compression method (%d)';
  RsCompressionGZIPHeaderCRC = 'gzip: CRC failed, header is damaged';
  RsCompressionGZIPDecompressing =
    'gzip: this property is not readable when the data are being decompressed';
  RsCompressionGZIPNotDecompressed =
    'gzip: this property is not readable until the data are fully decompressed';
  ...
  RsCompressionBZIP2EOFError =
    'bzip2 returned: unexpected end of file';
  RsCompressionBZIP2OutBuffError =
    'bzip2 returned: out buffer is too small';
...
resourcestring
  ...
  RsEDIError004 =
    'Could not get data object from %s at index [%s], Index too low.';
  RsEDIError005 =
    'Could not get data object from %s at index [%s], Index too high.';
  ...
  RsEDIError008 =
    'Could not set data object from %s at index [%s], Index too low.';
  RsEDIError009 =
    'Could not set data object from %s at index [%s], Index too high.';
  ...
  RsEDIError012 =
    'Delimiters have not been assigned to interchange.  Dissassemble cancelled.';
  RsEDIError013 =
    'Delimiters have not been assigned to interchange.  Assemble cancelled.';
  ...
  RsEDIError016 =
    'Could not find interchange control trailer segment terminator.';
  RsEDIError017 = 'Could not find interchange control trailer.';
  RsEDIError018 =
    'Could not find interchange control trailer or garbage at end of file.';
  RsEDIError019 =
    'Could not assign delimiters to functional group.  Dissassemble cancelled.';
  RsEDIError020 =
    'Could not assign delimiters to functional group.  Assemble cancelled.';
  RsEDIError021 = 'Could not find functional group header segment terminator.';
  RsEDIError022 = 'Could not find functional group header.';
 //conditional for UN/EDIFACT
  ...
  RsEDIError025 =
    'Could not assign delimiters to transaction set.  Dissassemble cancelled.';
  RsEDIError026 =
    'Could not assign delimiters to transaction set.  Assemble cancelled.';
  ...
  RsEDIError030 =
    'Could not assign delimiters to message.  Dissassemble cancelled.';
  ...
  RsEDIError035 =
    'Could not assign delimiters to segment.  Dissassemble cancelled.';
  RsEDIError036 = 'Could not assign delimiters to segment.  Assemble cancelled.';
  RsEDIError037 =
    'Could not assign delimiters to composite element.  Dissassemble cancelled.';
  RsEDIError038 =
    'Could not assign delimiters to composite element.  Assemble cancelled.';
  RsEDIError039 =
    'Could not get data object in transaction set loop at index [%s], ' +
    'Data object does not exist.';
  RsEDIError040 =
    'Could not get data object in transaction set loop at index [%s], ' +
    'Index too high.';
  RsEDIError041 =
    'Could not get data object in transaction set loop at index [%s], Index too low.';
  RsEDIError042 =
    'Could not get data object in transaction set loop at index [%s].';
  RsEDIError043 =
    'Could not set data object in transaction set loop at index [%s], ' +
    'Index too high.';
  RsEDIError044 =
    'Could not set data object in transaction set loop at index [%s], Index too low.';
  RsEDIError045 =
    'Could not set data object in transaction set loop at index [%s].';
  RsEDIError046 = 'Could not get data object in message loop at index [%s], ' +
    'Data object does not exist.';
  RsEDIError047 =
    'Could not get data object in message loop at index [%s], Index too high.';
  RsEDIError048 =
    'Could not get data object in message loop at index [%s], Index too low.';
  RsEDIError049 = 'Could not get data object in message loop at index [%s].';
  RsEDIError050 =
    'Could not set data object in message loop at index [%s], Index too high.';
  RsEDIError051 =
    'Could not set data object in message loop at index [%s], Index too low.';
  ...
  RsEDIError054 =
    'Could not get loop stack record at index [%s], Index too high.';
  ...
  RsEDIError058 =
    'Could not assign element specification to element at index [%s] '
    +
...
resourcestring
  ...
  EDIXMLError003 =
    'Could not assign delimiters to edi file.  Disassemble cancelled.';
  EDIXMLError004 =
    'Could not assign delimiters to edi file.  Assemble cancelled.';
  EDIXMLError005 =
    'Could not assign delimiters to interchange control. Disassemble cancelled.';
  EDIXMLError006 =
    'Could not assign delimiters to interchange control. Assemble cancelled.';
  ...
  EDIXMLError011 =
    'Could not find interchange control header end tag delimiter.';
  ...
  EDIXMLError014 =
    'Could not find interchange control trailer end tag delimiter.';
  EDIXMLError015 =
    'Could not assign delimiters to functional group. Disassemble cancelled.';
  EDIXMLError016 =
    'Could not assign delimiters to functional group. Assemble cancelled.';
  ...
  EDIXMLError025 =
    'Could not assign delimiters to transactoin set. Disassemble cancelled.';
  EDIXMLError026 =
    'Could not assign delimiters to transactoin set. Assemble cancelled.';
  EDIXMLError027 = 'Could not find transaction set end tag.';
  EDIXMLError028 = 'Could not find transaction set end tag delimiter.';
  EDIXMLError029 =
    'Could not assign delimiters to transactoin set loop. Disassemble cancelled.';
  EDIXMLError030 =
    'Could not assign delimiters to transactoin set loop. Assemble cancelled.';
  ...
  EDIXMLError036 =
    'Could not get data object at index [%s], There was no data object to get.';
  ...
  EDIXMLError039 =
    'Could not get data object at index [%s], Data object does not exist.';
  EDIXMLError040 = 'Could not delete EDI data object';
  EDIXMLError041 =
    'Could not assign delimiters to segment. Disassemble cancelled.';
  ...
  EDIXMLError046 =
    'Could not assign delimiters to element. Disassemble cancelled.';
  ...
  EDIXMLError054 =
    'Could not get element at index [%s], There was no element to get.';
  ...
  EDIXMLError057 =
    'Could not get element at index [%s], Element does not exist.';
  ...
  EDIXMLError062 =
    'TEDIXMLANSIX12FormatTranslator: Unexpected object [%s] found.';
...
resourcestring
  ...
  RsLoadFromStreamSize =
    'Not enough space in View in procedure LoadFromStream';
...
resourcestring
  RsBitsPerSampleNotSupported =
    '%d bits per sample not supported in color space conversion';
...
resourcestring
  ...
  RsMapiMailNoClient =
    'No Simple MAPI client installed, cannot send the message';
...
resourcestring
  ...
  RsInvalidSignatureData =
    'Invalid compressed signature data - %.2x %.2x %.2x %.2x';
  ...
  RsLocalVarSigOutOfRange =
    'LocalVarSig count %d is out of range [1..$$FFFE]';
...
resourcestring
  ...
  RsCreateProcBuild1057Error =
    'NT version 3.51 build 1057 or later required';

  RsCreateProcPrivilegeMissing =
    'This account does not have the privilege "%s" (%s)';
  ...
  RsCreateProcSetStationSecurityError =
    'Cannot set WindowStation "%s" security.';
  RsCreateProcSetDesktopSecurityError = 'Cannot set Desktop "%s" security.';
  RsCreateProcPrivilegesMissing =
    'This account does not have one (or more) of ' +
    'the following privileges: ' + '"%s"(%s)' + sLineBreak +
    '"%s"(%s)' + sLineBreak;
...
resourcestring
  // Multimedia timer
  RsMmTimerGetCaps =
    'Error retrieving multimedia timer device capabilities';
  RsMmTimerBeginPeriod = 'The supplied timer period value is out of range';
  RsMmSetEvent = 'Error setting multimedia event timer';
  RsMmInconsistentId =
    'Multimedia timer callback was called with inconsistent Id';
  RsMmTimerActive =
    'This operation cannot be performed while the timer is active';
...
resourcestring
  ...
  RsNtfsUnableToDeleteSymbolicLink =
    'Unable to delete temporary symbolic link';
...
resourcestring
  ...
  RsNATransmission =
    'Not all chars have been sent correctly to printer';
...
resourcestring
  ...
  RsScheduleNoDaySpecified =
    'At least one day of the week should be specified';
  RsScheduleIndexValueSup =
    'Property IndexValue not supported for current IndexKind';
...
resourcestring
  ...
  RsEInvalidXMLElementExpectedBeginningO =
    'Invalid XML Element: Expected beginning of tag but "%s" found';
  RsEInvalidXMLElementExpectedEndOfTagBu =
    'Invalid XML Element: Expected end of tag but "%s" found';
  RsEInvalidXMLElementMalformedTagFoundn =
    'Invalid XML Element: malformed tag found (no valid name)';
  RsEInvalidXMLElementErroneousEndOfTagE =
    'Invalid XML Element: Erroneous end of tag, expecting </%0:s> but </%1:s> found';
  RsEInvalidCommentExpectedsButFounds =
    'Invalid Comment: expected "%0:s" but found "%1:s"';
  RsEInvalidCommentNotAllowedInsideComme =
    'Invalid Comment: "--" not allowed inside comments';
  RsEInvalidCommentUnexpectedEndOfData =
    'Invalid Comment: Unexpected end of data';
  RsEInvalidCDATAExpectedsButFounds =
    'Invalid CDATA: expected "%0:s" but found "%1:s"';
  RsEInvalidCDATAUnexpectedEndOfData = 'Invalid CDATA: Unexpected end of data';
  RsEInvalidHeaderExpectedsButFounds =
    'Invalid Header: expected "%0:s" but found "%1:s"';
  RsEInvalidStylesheetExpectedsButFounds =
    'Invalid Stylesheet: expected "%0:s" but found "%1:s"';
  RsEInvalidStylesheetUnexpectedEndOfDat =
    'Invalid Stylesheet: Unexpected end of data';
  RsEInvalidDocumentUnexpectedTextInFile =
...
resourcestring
  ...
  RsInvalidEmptyStringItem =
    'String list passed to StringsToMultiSz cannot contain empty strings.';
...
resourcestring
  RsSynchAttachWin32Handle =
    'Invalid handle to TJclWin32HandleObject.Attach';
  RsSynchDuplicateWin32Handle =
    'Invalid handle to TJclWin32HandleObject.Duplicate';
  RsSynchInitCriticalSection = 'Failed to initalize critical section';
  RsSynchAttachDispatcher =
    'Invalid handle to TJclDispatcherObject.Attach';
  ...
  RsMetSectInvalidParameter =
    'An invalid parameter was passed to the constructor.';
  RsMetSectInitialize = 'Failed to initialize the metered section.';
  RsMetSectNameEmpty =
    'Name cannot be empty when using the Open constructor.';
...
resourcestring
  ...
  RsInvalidDigitValue =
    'There is no valid base %d digit for decimal value %d';
...
resourcestring
  ...
  RsURECharacterClassOpen =
    'Character class not closed, '']'' is missing.';
  RsUREUnbalancedGroup =
    'Unbalanced group expression, '')'' is missing.';
  ...
  RsURERepeatRangeOpen =
    'Repetition range not closed, ''}'' is missing.';
  ...
  RsCombiningClassUnicodeChar =
    'combining class for Unicode character > $FFFFFF found';

//=== JclUnitConv ============================================================
resourcestring
  RsTempConvTypeError =
    'An invalid type has been provided for the %s parameter';
...
resourcestring
  ...
  RsFormatBadArgumentType =
    'Invalid argument type (%s) at index %u. Expected [%s]';
  RsFormatBadArgumentTypeEx =
    'Invalid argument type (%s) at index %u for format ''%s''. Expected [%s]';

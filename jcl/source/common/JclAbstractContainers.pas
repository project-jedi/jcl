...
begin
  ...
  PPos := {$IFDEF RTL250_UP}System.AnsiStrings.{$ENDIF}StrPos(PString, PSep);
  if PPos <> nil then
  begin
    SepLen := {$IFDEF RTL250_UP}System.AnsiStrings.{$ENDIF}StrLen(PSep);
    repeat
      ...
      PPos := {$IFDEF RTL250_UP}System.AnsiStrings.{$ENDIF}StrPos(PString, PSep);
    until PPos = nil;
    if {$IFDEF RTL250_UP}System.AnsiStrings.{$ENDIF}StrLen(PString) > 0 then //ex. hello#world
      Add(PString);
  end

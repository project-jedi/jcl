...
function deflateInit_; external ZLibModuleName;
 // wrapped by deflateInit()
function deflate; external ZLibModuleName;
function deflateEnd; external ZLibModuleName;
function inflateInit_; external ZLibModuleName;
 // wrapped by inflateInit()
function inflate; external ZLibModuleName;
function inflateEnd; external ZLibModuleName;
function deflateInit2_; external ZLibModuleName;
 // wrapped by deflateInit2()
...
function inflateInit2_; external ZLibModuleName;
...
var
  ...
  window: PByte; {const} version: PChar;
  stream_size: Integer): Integer = nil;

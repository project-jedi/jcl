...
function TJclTD32InfoScanner.VAFromUnitAndProcName( UnitName, ProcName : string ): DWORD;
var
  i : Integer;
begin
  Result := 0;
  ...
  for i := 0 to ProcSymbolCount-1 do
    begin
    if ( CompareText( FormatProcName( Names[ ProcSymbols[ i ].FNameIndex ] ), {UnitName + '.' + }ProcName ) = 0 ) then
      begin

...
function _fwrite(buffer: Pointer; size: size_t; count: size_t; stream: Pointer): size_t; cdecl;
  external szMSVCRT name 'fwrite';
function _fread(buffer: Pointer; size: size_t; count: size_t; stream: Pointer): size_t; cdecl;
  external szMSVCRT name 'fread';
function _fclose(stream: Pointer): Integer; cdecl; external szMSVCRT name 'fclose';
function _vsnprintf(buffer: PChar; count: size_t; format: PChar; argptr: array of const): Integer;
  cdecl; external szMSVCRT name '_vsnprintf';
...
function deflateInit2(var strm: TZStreamRec; level: Integer; method: Integer; windowBits: Integer;

...
*)
  {$IFDEF SUPPORTS_GENERICS}
  //DOM-IGNORE-BEGIN
  (*$JPPEXPANDMACRO JCLSORTEDMAPTYPESINT(TJclMapEntry<TKey\,TValue>,TJclMapEntryArray<TKey\,TValue>,TKey,TValue)*)
  //DOM-IGNORE-END
  {$ENDIF SUPPORTS_GENERICS}
...
(*$JPPLOOP ALLMAPINDEX ALLMAPCOUNT
  {$JPPEXPANDMACRO SORTEDMAPENTRYITERATOR(,,,)}

*)
  {$IFDEF SUPPORTS_GENERICS}
  //DOM-IGNORE-BEGIN
  (*$JPPEXPANDMACRO SORTEDMAPENTRYITERATOR(IJclSortedMapIterator<TKey\,TValue>,IJclAbstractIterator,{570920D8-05ED-4CA5-8355-6A899555EBC0},TJclMapEntry<TKey\,TValue>)*)
  //DOM-IGNORE-END
  {$ENDIF SUPPORTS_GENERICS}
